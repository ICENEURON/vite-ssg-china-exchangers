...
export function AboutHero() {
    ...
    return (
        <section className="relative pt-24 pb-8 px-4 flex flex-col items-center text-center bg-gradient-to-b from-slate-50 from-90% to-transparent dark:from-slate-950 dark:from-90% dark:to-transparent overflow-hidden">
