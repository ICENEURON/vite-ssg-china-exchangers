...
export function TechSpecsForm({ units, onUnitChange, specs, onChange }: TechSpecsFormProps) {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white border border-slate-200 rounded-3xl p-6 md:p-10 shadow-sm">
