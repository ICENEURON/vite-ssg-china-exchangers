        ...
        <section className="pt-8 pb-12 md:pt-10 md:pb-14">
            <div className="container px-4 mx-auto max-w-6xl">
                ...
                <div className="mb-5 grid gap-3 md:grid-cols-3">
                    ...
                    <div className="rounded-sm border border-border/30 bg-card p-5 md:col-span-2">
                        <div className="mb-6 flex items-center gap-3">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                            {audienceSegments.map((segment) => (
                                <span key={segment} className="rounded-sm border border-blue-500/20 bg-blue-500/10 px-3 py-1 text-xs font-semibold text-blue-600">
                                    {segment}
                                </span>
                            ))}
                        </div>
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-3 md:gap-4">
                    ...
                    <div className="group relative overflow-hidden rounded-sm border border-slate-800 bg-slate-900 text-white p-8 md:col-span-2 flex flex-col justify-between transition-colors hover:border-blue-600 min-h-[300px] md:min-h-[300px]">
                        ...
                        <div className="w-full h-16 mt-6 flex items-end gap-1">
                            {[40, 65, 55, 80, 70, 90, 85, 100].map((h, i) => (
                                <div key={i} className="flex-1 rounded-sm bg-white/20 transition-colors group-hover:bg-white/30" style={{ height: `${h}%` }} />
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="group relative rounded-sm border border-border/20 bg-card p-8 min-h-[300px] flex flex-col justify-between hover:border-purple-500/30 transition-colors">
                        <div>
                            <div className="mb-6 flex items-center gap-3">
                    ...
                    <div className="group relative overflow-hidden rounded-sm border border-border/20 bg-card p-8 min-h-[220px] flex flex-col justify-between transition-colors hover:border-purple-500/30">
                        <div>
                            <div className="mb-6 flex items-center gap-3">
                                <ClipboardCheck className="h-6 w-6 shrink-0 text-purple-500" />
                    ...
                    <div className="group relative grid grid-cols-1 items-center gap-5 overflow-hidden rounded-sm border border-slate-800 bg-slate-900 p-8 text-white transition-all ring-blue-400/40 hover:ring-2 sm:grid-cols-3 md:col-span-2 md:gap-8">
                        <div className="relative overflow-hidden rounded-sm border border-white/10 bg-white/5 p-4 w-full min-h-[160px] sm:col-span-1">
                            <div className="flex items-center gap-3 mb-3 pb-3 border-b border-white/10">
                                <div className="w-8 h-8 rounded-sm bg-gradient-to-br from-orange-400 to-red-500" />
                                <div>
                                    <div className="w-20 h-2 bg-white/20 rounded-sm mb-1" />
                        ...
                        <div className="text-center sm:text-left sm:col-span-2">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                                <span className="px-3 py-1 rounded-sm bg-white/10 text-xs border border-white/10">{t("items.verified.tags.visibility")}</span>
                                <span className="px-3 py-1 rounded-sm bg-white/10 text-xs border border-white/10">{t("items.verified.tags.trust")}</span>
                                <span className="px-3 py-1 rounded-sm bg-white/10 text-xs border border-white/10">{t("items.verified.tags.expert")}</span>
                            </div>
                        </div>
                    </div>
                </div>
