...
>(({ className, ...props }, ref) => (
  <div className="absolute top-full left-0 flex justify-center w-full">
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-4 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-m border border-border shadow md:w-8",
        className
      )}
      ref={ref}
      {...props}
