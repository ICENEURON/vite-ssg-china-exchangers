...
Public routes include `/`, `/manufacturers`, `/manufacturers/:slug`, `/products`, `/products/:manufacturerSlug/:productSlug`, `/rfq`, `/claim-your-profile`, `/content-marketing-services`, `/about`, `/contact`, `/terms`, and `/privacy`.
...
公开路由包括 `/`、`/manufacturers`、`/manufacturers/:slug`、`/products`、`/products/:manufacturerSlug/:productSlug`、`/rfq`、`/claim-your-profile`、`/content-marketing-services`、`/about`、`/contact`、`/terms`、`/privacy`。
