...
El sistema utiliza CO₂ supercrítico como fluido de trabajo y logra una conversión eficiente de calor en electricidad a través de un ciclo cerrado sin cambio de fase gas-líquido en el sentido tradicional. El ciclo consta de seis etapas clave: el fluido de trabajo a baja temperatura y presión (33 °C, 8,1 MPa) se comprime mediante un compresor a 20-23 MPa. Luego pasa secuencialmente por un recuperador de baja temperatura y un recuperador de alta temperatura para recuperar el calor residual y elevar su temperatura.

A continuación, se calienta mediante un calentador, utilizando fuentes de calor como el calor residual industrial o la energía solar térmica, a 500-800 °C y entra en un conjunto de turbina-generador para realizar trabajo y generar electricidad. Finalmente, es enfriado por un refrigerador hasta su estado inicial, completando el ciclo. Los datos de la investigación muestran que cuando la temperatura de entrada de la turbina supera los 550 °C, la eficiencia térmica del ciclo es entre un 20% y un 50% mayor que la de un ciclo Rankine de vapor tradicional, y el uso de agua se reduce en un 50%.

Los recuperadores y el enfriador manejan más del 90% del trabajo de intercambio de calor, lo que los hace críticos para el funcionamiento eficiente del sistema.
...
Los PCHE pueden soportar presiones de hasta 100 MPa y temperaturas superiores a 800 °C, lo que garantiza un funcionamiento estable y sin fugas en condiciones extremas de alta presión y alta temperatura.
...
La caída de presión en los PCHE es sólo entre 1/3 y 1/2 de la de los intercambiadores tradicionales. Para un sistema de clase de 10 MW, esto da como resultado una reducción del 6% al 8% en las pérdidas de presión totales del sistema y un aumento de 2 a 3 puntos porcentuales en la producción de energía neta.

### Diseño muy compacto y ligero

Los PCHE presentan una superficie específica superior a 2500 m²/m³, lo que permite que su volumen sea sólo 1/4-1/6 del de los intercambiadores de carcasa y tubos equivalentes. Su peso significativamente menor también facilita la integración del sistema.

### Excelente flexibilidad del material
