...
readTime: "9 minutes"
excerpt: "Heat exchanger inquiry list for overseas procurement, engineering companies and distributors, explaining how to prepare working conditions, media, materials, standards, accessories and supplier..."
metaTitle: "Heat exchanger inquiry list: What materials are recommended to be prepared before submitting a quotation request?"
metaDescription: "Heat exchanger inquiry list: What working conditions, media, materials, standards, drawings, accessories and supplier issues are recommended to be prepared before purchasing heat exchangers to help buyers reduce invalid quotations."
keywords: ["Heat exchanger inquiry list","heat exchanger quote checklist","Heat exchanger procurement","Heat exchanger quotation information","China heat exchanger supplier"]
...
The purpose of this checklist is to help the purchaser transform the inquiry from "price inquiry" to "communication of engineering specifications." If you already have a process package, TEMA datasheet, P&ID, GA drawing or old equipment nameplate, you can submit it directly through [Inquiry Form](/quote-request). If there is no complete document yet, you can first organize the key data according to the table in this article so that the supplier can determine the direction.
...
For [removable plate heat exchanger](/products/shanghai-heat-transfer-equipment-co-ltd/gasketed-plate-heat-exchanger), the applicable temperature of the plate material, gasket material and gasket is the key; for [Brazed plate heat exchanger](/products/siping-juyuan-hanyang-plate-heat-exchanger-co-ltd/brazed-plate-heat-exchanger), the brazing material, cleanliness and maintainability need to be confirmed in advance; for [Welded plate heat exchanger](/products/shanghai-heat-transfer-equipment-co-ltd/tp-welded-plate-heat-exchanger), welding seams, non-destructive testing and cleaning methods will directly affect the quotation.

## 4. On-site constraints determine whether the quotation is true

The equipment size given by the supplier is not only the result of thermal calculation, but also affected by the site space, pipe opening direction, maintenance access, lifting path, foundation load and transportation conditions. The purchaser can provide general layout drawings, on-site photos, maximum overall dimensions, interface flange standards, pipe mouth direction requirements, whether thermal insulation is required, and whether there are explosion-proof or outdoor requirements. For [Heat Exchange Unit](/products/lanzhou-lanshi-heat-exchange-equipment-co-ltd/plate-heat-exchanger-unit), you can also specify pumps, valves, instruments, control cabinets and power supply requirements; for air-side equipment, it is recommended to specify whether it is installed indoors, outdoors, on the roof, or in an air duct.

## 5. It is recommended to prepare the quotation attachments at one time

A high-quality inquiry attachment package can include: process parameter sheet, old equipment nameplate, P&ID, general arrangement drawing, nozzle table, material requirements, inspection requirements, project specifications, photos, target delivery date, and packaging and transportation requirements. When complete information is not available, you can also upload handwritten sketches or on-site photos, and indicate which data are confirmed and which are just estimates. [Inquiry form](/quote-request) supports uploading images, Word, Excel, PDF and CSV, and is suitable for submitting these materials together.
...
If you are still not sure whether to choose plate, shell and tube, welded plate or air heat exchanger, you can first browse [Product Catalog](/products) and [Manufacturer List](/manufacturers), and then submit preliminary working conditions to HeatEx Direct. We will organize the inquiry based on the type of working conditions, industry and data completeness, and transfer the demand to a more suitable supplier.
